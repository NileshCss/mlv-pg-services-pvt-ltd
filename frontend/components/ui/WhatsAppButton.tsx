  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <AnimatePresence>
        {expanded && (
          <motion.div
            ...
            className="relative rounded-2xl px-5 py-4 shadow-2xl max-w-[240px] text-right"
            style={{
          ...
          >
            <button
              ...
              className="absolute top-2 right-2 w-5 h-5 flex items-center justify-center rounded-full text-gray-500 hover:text-white transition-colors"
            >
              <X size={12} />
            </button>
            <p className="text-xs text-gray-400 mb-1">Chat with us on</p>
            <p className="text-sm font-bold text-white mb-3">WhatsApp</p>
            <a
            ...
            <div
              ...
              style={{ background: '#111827', borderRight: '1px solid rgba(255,255,255,0.08)', borderBottom: '1px solid rgba(255,255,255,0.08)' }}
            />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <motion.button
        ...
        animate={{ y: expanded ? 0 : [0, -6, 0] }}
        transition={expanded ? {} : { duration: 2.5, repeat: Infinity, ease: 'easeInOut' }}
