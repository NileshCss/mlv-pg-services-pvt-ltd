    ...
    <section id="home" className="relative bg-[#FDF9F3] text-[#1C1C3A] font-jakarta overflow-hidden pt-4 pb-16 lg:pb-24 min-h-[60vh] md:min-h-[75vh] lg:min-h-[85vh] flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          >
            ...
            >
              ...
              <span className="block">
                with Authentic{' '}
                <span className="text-[#D4A017] font-playfair font-bold italic text-[1.05em] leading-none">
                  North Indian Food
                </span>
              </span>
            </motion.h1>
            ...
            {/* CTA Buttons */}
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 mb-10 w-full sm:w-auto items-center justify-center lg:justify-start">
              <button 
                onClick={onBookClick}
                className="bg-[#D4A017] border-2 border-transparent text-white rounded-full px-6 py-3 font-semibold hover:bg-[#B8891A] transition-all duration-300 shadow-xl shadow-[#D4A017]/25 hover:shadow-2xl hover:shadow-[#D4A017]/30 hover:-translate-y-0.5 w-full sm:w-auto text-center text-base"
              >
                Pre-Reserve Now
              </button>
              <button 
                onClick={onContactClick}
                className="border-2 border-solid border-[#D4A017] bg-white text-[#D4A017] rounded-full px-6 py-3 font-semibold hover:bg-[#D4A017] hover:text-white transition-all duration-300 w-full sm:w-auto text-center text-base"
              >
                Book a Visit
              </button>
            </motion.div>
            ...
            >
              ...
              <div className="w-px h-10 bg-[#1C1C3A]/15" />
              ...
              <div className="w-px h-10 bg-[#1C1C3A]/15 hidden sm:block" />
          ...
          {/* ── Right Side Image Column (Desktop only) ── */}
          <motion.div 
            ...
            <div className="relative rounded-[2rem] overflow-hidden aspect-[4/5] shadow-2xl border-4 border-white transform rotate-1 hover:rotate-0 transition-transform duration-700">
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="flex text-[#D4A017] text-lg">★★★★★</div>
                ...
                <p className="text-sm font-semibold text-[#1C1C3A]/80 italic leading-relaxed">
                  &ldquo;The only PG where I get real North Indian rotis and dal. It saves me from missing home.&rdquo;
                </p>
              </motion.div>
            </div>
